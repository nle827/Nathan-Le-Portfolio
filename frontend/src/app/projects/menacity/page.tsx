...
// Image fit config — adjust as needed
const imageFitConfig = {
  mainImageFit: "contain", // or "contain"
  galleryFits: ["cover", "cover", "cover", "cover", "cover", "cover", "cover", "cover", "cover"], // corresponds to each gallery image
};
    ...
    {[menacity1, menacity2, menacity3, menacity7, menacity4, menacity6, menacity5, menacity8, menacity9].map((img, index) => {
      ...
      return (
        ...
        >
          <img
            src={img}
            width={600}      // or your resized width
            height={1066} 
